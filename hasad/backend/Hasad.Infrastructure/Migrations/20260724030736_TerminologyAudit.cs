...
namespace Hasad.Infrastructure.Migrations
{
    ...
    public partial class TerminologyAudit : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "DamageCategories",
                columns: new[] { "Id", "AgriculturalSectorId", "NameAr", "NameEn" },
                values: new object[,]
                {
                    { 1, 1, "محاصيل حقلية", "Field Crops" },
                    { 2, 1, "خضروات", "Vegetables" },
                    { 3, 1, "أشجار مثمرة", "Fruit Trees" },
                    { 4, 1, "أشجار زيتون", "Olive Trees" },
                    { 5, 1, "دفيئات", "Greenhouses" },
                    { 6, 1, "مشاتل", "Nurseries" },
                    { 7, 2, "أبقار", "Cattle" },
                    { 8, 2, "أغنام", "Sheep" },
                    { 9, 2, "ماعز", "Goats" },
            ...
            migrationBuilder.InsertData(
                ...
                columns: new[] { "Id", "CategoryId", "NameAr", "NameEn" },
                values: new object[,]
                {
                    { 1, 1, "حبوب", "Cereals" },
                    { 2, 2, "مكشوفة", "Open Field" },
                    { 3, 3, "حمضيات", "Citrus" },
                    { 4, 3, "فواكه أخرى", "Other Fruits" },
                    { 5, 5, "خضروات محمية", "Protected Vegetables" },
                    { 6, 7, "إنتاج حليب", "Dairy" },
                    { 7, 10, "لاحم", "Broilers" },
                    { 8, 11, "خلايا نحل", "Hives" }
                });

            migrationBuilder.InsertData(
                table: "DamageClassifications",
                columns: new[] { "Id", "NameAr", "NameEn", "SubCategoryId" },
                values: new object[,]
                {
                    { 1, "قمح", "Wheat", 1 },
                    { 2, "شعير", "Barley", 1 },
