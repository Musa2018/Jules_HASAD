...
namespace Hasad.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260819222656_AddAdminReportsNotificationsInfrastructure")]
    partial class AddAdminReportsNotificationsInfrastructure
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Hasad.Domain.Entities.AdminAuditLog", b =>
                {
            ...
            modelBuilder.Entity("Hasad.Domain.Entities.AdminUser", b =>
                {
            ...
            modelBuilder.Entity("Hasad.Domain.Entities.CostingSheetCatalog", b =>
                {
                    ...
                    b.ToTable("CostingSheetCatalogs");
                });
            ...
            modelBuilder.Entity("Hasad.Domain.Entities.CostingSheetItem", b =>
                {
                    ...
                    b.ToTable("CostingSheetItems");
                });

            modelBuilder.Entity("Hasad.Domain.Entities.CostingSheetVersion", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Hasad.Domain.Entities.DamageItem", b =>
                {
                    ...
                    b.Property<Guid>("CostingSheetItemId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Hasad.Domain.Entities.DamageReportSequence", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Hasad.Domain.Entities.DashboardKpiMetric", b =>
                {
            ...
            modelBuilder.Entity("Hasad.Domain.Entities.DocumentType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            ...
                            IsActive = true,
                            IsRequired = false,
                            NameAr = "استمارة حصر الأضرار",
                            NameEn = "Damage Assessment Form"
                        },
                        new
                        {
                            Id = 5,
                        ...
                        new
                        {
                            ...
                            IsActive = true,
                            IsRequired = false,
                            NameAr = "قرار مدير عام",
                            NameEn = "Director General Decision"
                        },
                        new
                        {
                            Id = 7,
            ...
            modelBuilder.Entity("Hasad.Domain.Entities.MeasurementUnit", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Hasad.Domain.Entities.Notification", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Hasad.Domain.Entities.NotificationRecipient", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Hasad.Domain.Entities.ReportDefinition", b =>
                {
            ...
            modelBuilder.Entity("Hasad.Domain.Entities.ReportExecutionLog", b =>
                {
            ...
            modelBuilder.Entity("Hasad.Domain.Entities.UserDevice", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("UserId", "IsOnline");

                    b.ToTable("UserDevices");
                });

            modelBuilder.Entity("Hasad.Domain.Entities.UserReportPreset", b =>
                {
                    b.Property<long>("PresetId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<long>("PresetId"));
            ...
            modelBuilder.Entity("Hasad.Domain.Entities.AdminAuditLog", b =>
                {
                    b.HasOne("Hasad.Domain.Entities.AdminUser", "AdminUser")
                        .WithMany()
            ...
            modelBuilder.Entity("Hasad.Domain.Entities.AdminUser", b =>
                {
                    b.HasOne("Hasad.Domain.Identity.ApplicationUser", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("Hasad.Domain.Entities.CostingSheetItem", b =>
                {
                    b.HasOne("Hasad.Domain.Entities.DamageClassification", "Classification")
                        .WithMany("CostingSheetItems")
                        .HasForeignKey("ClassificationId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Hasad.Domain.Entities.MeasurementUnit", "MeasurementUnit")
                        .WithMany()
                        .HasForeignKey("MeasurementUnitId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("Hasad.Domain.Entities.CostingSheetVersion", "Version")
                        .WithMany("Items")
            ...
            modelBuilder.Entity("Hasad.Domain.Entities.CostingSheetVersion", b =>
                {
                    b.HasOne("Hasad.Domain.Entities.CostingSheetCatalog", "Catalog")
                        .WithMany("Versions")
            ...
            modelBuilder.Entity("Hasad.Domain.Entities.DamageItem", b =>
                {
                    ...
                    b.HasOne("Hasad.Domain.Entities.CostingSheetItem", "CostingSheetItem")
                        .WithMany()
                        .HasForeignKey("CostingSheetItemId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("Hasad.Domain.Entities.DamageReportAttachment", b =>
                {
                    ...
                    b.HasOne("Hasad.Domain.Entities.DocumentType", "DocumentType")
                        .WithMany()
            ...
            modelBuilder.Entity("Hasad.Domain.Entities.NotificationRecipient", b =>
                {
                    b.HasOne("Hasad.Domain.Entities.Notification", "Notification")
                        .WithMany("Recipients")
            ...
            modelBuilder.Entity("Hasad.Domain.Entities.UserReportPreset", b =>
                {
                    b.HasOne("Hasad.Domain.Entities.ReportDefinition", "ReportDefinition")
                        .WithMany("Presets")
