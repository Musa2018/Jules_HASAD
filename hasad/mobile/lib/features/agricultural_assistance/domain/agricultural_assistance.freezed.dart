...
/// @nodoc
mixin _$AgriculturalAssistance {
...
class _$AgriculturalAssistanceImpl implements _AgriculturalAssistance {
  ...
  @override
  String toString() {
    return 'AgriculturalAssistance(id: $id, clientId: $clientId, damageReportId: $damageReportId, calculatedAmount: $calculatedAmount, approvedAmount: $approvedAmount, status: $status, remarks: $remarks, rowVersion: $rowVersion)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$AgriculturalAssistanceImpl &&
