...
part of 'damage_report_filter.dart';
...
/// @nodoc
class _$DamageReportFilterCopyWithImpl<$Res, $Val extends DamageReportFilter>
    implements $DamageReportFilterCopyWith<$Res> {
  _$DamageReportFilterCopyWithImpl(this._value, this._then);
...
class _$DamageReportFilterImpl implements _DamageReportFilter {
  ...
  @override
  String toString() {
    return 'DamageReportFilter(searchText: $searchText, statusId: $statusId, syncStatus: $syncStatus, governorateId: $governorateId, directorateId: $directorateId, localityId: $localityId)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$DamageReportFilterImpl &&
