...
_$ReferenceDataImpl _$$ReferenceDataImplFromJson(Map<String, dynamic> json) =>
    _$ReferenceDataImpl(
      ...
      politicalClassifications:
          (json['politicalClassifications'] as List<dynamic>)
              .map((e) =>
                  PoliticalClassification.fromJson(e as Map<String, dynamic>))
              .toList(),
      ...
      damageCauses: (json['damageCauses'] as List<dynamic>)
          ...
          .toList(),
      costingSheetCatalogs: (json['costingSheetCatalogs'] as List<dynamic>?)
              ?.map((e) =>
                  CostingSheetCatalog.fromJson(e as Map<String, dynamic>))
              .toList() ??
          const [],
      costingSheetVersions: (json['costingSheetVersions'] as List<dynamic>?)
              ?.map((e) =>
                  CostingSheetVersion.fromJson(e as Map<String, dynamic>))
              .toList() ??
          const [],
      costingSheetItems: (json['costingSheetItems'] as List<dynamic>?)
              ?.map((e) => CostingSheetItem.fromJson(e as Map<String, dynamic>))
              .toList() ??
          const [],
      legacyCostingSheets: (json['costingSheets'] as List<dynamic>?)
              ?.map((e) => CostingSheetItem.fromJson(e as Map<String, dynamic>))
              .toList() ??
          const [],
    );
